...
const byte g_cNegative12[] = "ID_STR_FLASHNEG_12";
const byte g_cNegative13[] = "ID_STR_FLASHNEG_13";
const byte g_cNegative22[] = "ID_STR_FLASHNEG_22";
const byte g_cNegative24[] = "ID_STR_FLASHNEG_24";
const byte g_cNegative31[] = "ID_STR_FLASHNEG_31";
const byte g_cNegative33[] = "ID_STR_FLASHNEG_33";
const byte g_cNegative35[] = "ID_STR_FLASHNEG_35";
const byte g_cNegative36[] = "ID_STR_FLASHNEG_36";
const byte g_cNegative37[] = "ID_STR_FLASHNEG_37";
const byte g_cNegative72[] = "ID_STR_FLASHNEG_72";
const byte g_cNegative7E[] = "ID_STR_FLASHNEG_7E";
const byte g_cNegative7F[] = "ID_STR_FLASHNEG_7F";
const byte g_cNegativeOther[] = "ID_SRT_FLASHNEG_OTHTER";
